        ...
        <div className="bg-white dark:bg-[#23231c] border border-[#ecece0] dark:border-[#38382e] rounded-none max-w-4xl w-full p-4 sm:p-6 shadow-xl text-[#2c2c26] dark:text-[#f0efe6] relative my-4 flex flex-col max-h-[92vh] animate-in fade-in duration-150">
          ...
          <div className="border-b border-[#ecece0] dark:border-[#38382e] pb-4 pr-8">
            <div className="flex flex-wrap items-center gap-2 mb-2">
              ...
              <span className="text-xs text-[#5c5c52] dark:text-[#a8a89b] flex items-center gap-1">
          ...
          <div className="pt-3 border-t border-[#ecece0] dark:border-[#38382e] flex items-center justify-between">
            <button
              ...
              className="px-3 py-1.5 bg-[#c86d51]/10 dark:bg-[#c86d51]/20 hover:bg-[#c86d51]/20 dark:hover:bg-[#c86d51]/30 text-[#96472d] dark:text-[#e07a5f] border border-[#c86d51]/30 rounded-none text-xs font-bold flex items-center gap-1.5 transition cursor-pointer"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={onClose}
                className="px-4 py-2 bg-[#3a3a30] dark:bg-[#2c2c24] hover:bg-[#2c2c26] dark:hover:bg-[#38382e] text-[#fbfaf5] rounded-none text-xs font-bold transition cursor-pointer uppercase tracking-wider"
              >
                Done
              </button>
            </div>
